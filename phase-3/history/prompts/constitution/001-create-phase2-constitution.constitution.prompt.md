...
Carefully read and deeply analyze the provided **Hackathon Documentation**, including:
- Problem statement
- Rules & guidelines
- Phases breakdown
- Evaluation criteria
...
- Any existing Phase-1 outputs

### Your Task:
1. **End-to-End Analysis**
   - Analyze the hackathon from start to finish.
   - Clearly understand the vision, goals, constraints, and success criteria.

2. **Phase-2 Constitution Creation**
   Write a **complete, production-ready Phase-2 Constitution**, covering:
...
3. **Clarity & Quality Rules**
   - Use clear headings and subheadings
   - Write in professional, simple English
   - Be precise, structured, and implementation-focused
   - Assume this document will be used by real developers

⚠️ Do not skip any section.
⚠️ Treat this as an official Phase-2 constitution document.
...
- ✅ Impact: Created comprehensive Phase II constitution for Todo App Hackathon
- 🧪 Tests: N/A
- 📁 Files: Updated .specify/memory/constitution.md with complete Phase II requirements
- 🔁 Next prompts: Continue with Phase II implementation following the constitution
- 🧠 Reflection: The constitution provides clear guidelines for Phase II implementation, covering all required aspects from architecture to evaluation criteria
...
- Next experiment (smallest change to try): Begin implementing Phase II features according to the constitution