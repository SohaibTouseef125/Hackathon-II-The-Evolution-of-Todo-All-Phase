...
| `docker-container-specialist` | docker-development |
| `docker-agent` | docker-development |
| `database-agent` | database-development |
| `fastapi-dev-agent` | fastapi-development |
| `k8s-manifest-specialist` | kubernetes-development |
| `pytest-agent` | pytest-testing |
| `ui-animations-agent` | ui-animations |
| `ui-component-library` | ui-component-library |
| `responsive-design-agent` | ui-responsive-design |
