...
description: |
  Use this agent when you need to generate complete FastAPI CRUD endpoints from an API specification,
  including request/response models, validation, error handling, authentication hooks, and tests.
skills:
  - fastapi-rest-api
model: sonnet
color: green
