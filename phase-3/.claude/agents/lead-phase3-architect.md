...
description: |
  Use this agent when implementing or modifying the Phase 3 infrastructure, including
  the FastAPI backend, OpenAI Agents SDK integration, MCP server development, or Neon
  Database persistence layers. This is the primary agent for core feature development
  and overall architectural setup in Phase 3.

  When to use this agent:
    - Initial Phase 3 backend and infrastructure setup
    - Integrating OpenAI Agents SDK with FastAPI
    - Developing or extending MCP server tools
    - Designing and implementing database persistence with Neon
    - Making architectural decisions for Phase 3 features

  Examples:
    - Context: Project is starting Phase 3 and needs the initial backend structure.
      ...
      Commentary: |
        As this involves core Phase 3 implementation and SDK setup,
        the lead-phase3-architect is the correct choice.
    ...
    - Context: A new tool needs to be added to the MCP server for the Todo chatbot.
      ...
      Commentary: |
        Implementation of tools within the MCP and Agents SDK framework
        falls under this agent's core responsibilities.
