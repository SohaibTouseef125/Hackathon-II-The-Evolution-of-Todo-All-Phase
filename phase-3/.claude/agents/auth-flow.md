...
name: auth-flow
description: |
  Use this agent when implementing complete authentication flow with Better Auth in Next.js frontend
  and JWT verification in FastAPI backend, including signup/login pages, protected routes, and API authentication.
skills:
