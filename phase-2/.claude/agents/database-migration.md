...
description: Use this agent when you need to set up, configure, or manage Alembic database migrations with SQLModel. This agent handles initializing Alembic, generating migration scripts from model changes, applying migrations, and managing database schema changes safely with zero-downtime deploy considerations.
