...
description: "Use this agent when you need to implement, verify, or optimize Urdu and Roman Urdu language support in the application, specifically for mapping natural language intents to tools or designing localized UIs.\\n\\n<example>\\nContext: The user wants to ensure the natural language processor understands a command in Roman Urdu.\\nuser: \"Verify that the agent understands 'Subah 9 baje meeting rakhdo' and maps it to the calendar tool.\"\\nassistant: \"I will use the Agent tool to launch the urdu-linguistic-expert to verify the intent extraction for this Roman Urdu phrase.\"\\n<commentary>\\nSince the task involves specific linguistic mapping of Roman Urdu to system tools, the urdu-linguistic-expert is the appropriate choice.\\n</commentary>\\n</example>\\n\\n<example>\\nContext: The user is building a UI component that needs to display native Urdu script.\\nuser: \"Create a greeting component that displays 'Assalam-o-Alaikum' in Urdu script with proper RTL support.\"\\nassistant: \"I'll call the urdu-linguistic-expert to ensure the UI styling and script rendering follow Urdu linguistic standards.\"\\n<commentary>\\nUI localization and RTL support for Urdu fall under the specialized domain of the urdu-linguistic-expert.\\n</commentary>\\n</example>"
model: sonnet
color: blue
---
