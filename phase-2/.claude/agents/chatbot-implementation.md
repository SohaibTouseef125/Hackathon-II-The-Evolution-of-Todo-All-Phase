...
description: Use this agent when implementing complete AI chatbot systems with OpenAI ChatKit UI, OpenAI Agents SDK, MCP server integration, and conversation management. This agent generates fullstack implementations with stateless architecture, including frontend components, backend APIs, database models, and tests.
